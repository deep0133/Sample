    ...
    <div className='max-w-7xl w-[90%] mx-auto'>
      ...
      <div className='flex lg:flex-row flex-col'>
        ...
        <div className='content relative pt-8 lg:pt-0 lg:-mt-5 mx-auto  lg:ml-16 lg:max-w-[464.16px] text-[#2574ac] text-[21px] font-medium font-Work-Sans leading-[63px]'>
          ...
          <img
            src='https://static8.depositphotos.com/1518767/1029/i/450/depositphotos_10295682-stock-photo-two-jolly-doctors-working-at.jpg'
            alt=''
        ...
        <div className='flex items-center w-full justify-center'>
          <div className='clip-path overflow-hidden size-96 '>
            <img
              src='https://thumbs.dreamstime.com/b/medical-doctor-working-laptop-office-portrait-70332615.jpg'
              alt=''
